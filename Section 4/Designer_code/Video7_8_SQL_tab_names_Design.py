...
# Form implementation generated from reading ui file 'Video6_8_SQL_tab_names_Design.ui'
#
...
"color: rgb(255, 255, 255);")
        ...
        self.pushButton_3_view_data = QtWidgets.QPushButton(self.verticalLayoutWidget_4)
        self.pushButton_3_view_data.setObjectName("pushButton_3_view_data")
        self.verticalLayout_3.addWidget(self.pushButton_3_view_data)
        self.pushButton_2_add_row = QtWidgets.QPushButton(self.verticalLayoutWidget_4)
        self.pushButton_2_add_row.setObjectName("pushButton_2_add_row")
        self.verticalLayout_3.addWidget(self.pushButton_2_add_row)
        self.pushButton_delete_row = QtWidgets.QPushButton(self.verticalLayoutWidget_4)
        self.pushButton_delete_row.setObjectName("pushButton_delete_row")
        self.verticalLayout_3.addWidget(self.pushButton_delete_row)
        self.pushButton_4_create_db = QtWidgets.QPushButton(self.verticalLayoutWidget_4)
        self.pushButton_4_create_db.setObjectName("pushButton_4_create_db")
        self.verticalLayout_3.addWidget(self.pushButton_4_create_db)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.pushButton_3_view_data.setText(_translate("MainWindow", "View Data"))
        self.pushButton_2_add_row.setText(_translate("MainWindow", "Add Row"))
        self.pushButton_delete_row.setText(_translate("MainWindow", "Delete Row"))
        self.pushButton_4_create_db.setText(_translate("MainWindow", "Create DB"))
